describe('Ramen.view.Box', function () {
    var view;

    beforeEach(function () {
        view = JSoop.create('Ramen.view.Box', {
            baseId: 'testing',
            baseCls: 'testing',
            cls: [
                'additional',
    ...
    it('should register itself with the ViewManager', function () {
        expect(Ramen.view.ViewManager.indexOf(view)).not.toBe(-1);
    });
    ...
    it('should correctly destroy itself', function () {
        ...
        expect(Ramen.view.ViewManager.indexOf(view)).toBe(-1);
