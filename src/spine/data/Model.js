/**
 * @class Spine.data.Model
 * A model represents a single set of data.
 */
JSoop.define('Spine.data.Model', {
    mixins: {
    ...
    config: {
        required: [
            /**
             * @cfg {Spine.data.Field[]/Object[]} fields (required)
    ...
    /**
     * @cfg {Spine.data.Association[]/Object[]} associations
    ...
    onExtended: function (data, hooks) {
        ...
        hooks.onBeforeCreated = function (data, hooks) {
            var me = this,
                statics = (JSoop.objectQuery('Spine.data.Model'))? Spine.data.Model : data.statics;
    ...
    statics: {
        ...
        initFields: function () {
            ...
            JSoop.each(fields, function (field, index) {
                if (!field.isField) {
                    field = JSoop.create('Spine.data.Field', field);
                }
        ...
        initAssociations: function () {
            ...
            JSoop.each(associations, function (association, index) {
                ...
                if (!association.isAssociation) {
                    ...
                    association = JSoop.create('Spine.data.association.' + type, association);
                }
    ...
    constructor: function (data, config) {
        ...
        if (fields) {
            Spine.data.Model.addFields.call(me, fields);
        }
